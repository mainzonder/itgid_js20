...
document.querySelector('.b-10').onclick = () => {
    ...
    document.querySelector('.out-10').innerHTML = f10(a10, 12);
};
...
function f15() {
    ...
    for (let i = 0; i < arr15.length; i++) {
        for (let k = 0; k < arr15[i].length; k++) {
    ...
    for (let key in a18) {
        ...
        if (key == i18) {
            ...
            for (let i = 0; i < arr18.length; i++) {
                for (let k = 0; k < arr18[i].length; k++) {
...
function f19() {
    ...
    for (key1 in a19) {
        let a = ""
            // arr19.push(a19[key])
        for (let key2 in a19[key1]) {
            num.push(a19[key1][key2])
            a = num.includes(i19)
        }
...
function f20() {
    ...
    for (let key1 in a20) {
        ...
        for (let key2 in a20[key1]) {

            arr20.push(a20[key1][key2])
